...
if (!Script.preview) {
  ...
  const binaryPkgbuild = [
    ...
    "depends=('fzf' 'ripgrep')",
    "",
    `source_aarch64=("\${pkgname}_\${pkgver}_aarch64.zip::https://github.com/sst/opencode/releases/download/v\${_pkgver}/opencode-linux-arm64.zip")`,
    `sha256sums_aarch64=('${arm64Sha}')`,
    "",
    `source_x86_64=("\${pkgname}_\${pkgver}_x86_64.zip::https://github.com/sst/opencode/releases/download/v\${_pkgver}/opencode-linux-x64.zip")`,
  ...
  const sourcePkgbuild = [
    ...
    "",
    `source=("opencode-\${pkgver}.tar.gz::https://github.com/sst/opencode/archive/v\${_pkgver}.tar.gz")`,
    `sha256sums=('SKIP')`,
    "",
    "build() {",
    `  cd "opencode-\${pkgver}"`,
